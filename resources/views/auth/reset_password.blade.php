...
<head>
	...
	<title>The Silver foundation | Reset Password</title>
</head>
						...
						<div class="card rounded-0 m-3 shadow-none bg-transparent mb-0">
							<div class="card-body p-sm-5">
								...
								<form action="{{ route('reset.password.post') }}" method="POST">
									...
									<input type="hidden" name="email" value="{{session('email')}}" class="form-control" />

									<div class="mb-3 mt-4">
										<label class="form-label" id="show_hide_password">New Password</label>
