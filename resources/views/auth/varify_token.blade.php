						...
						<div class="card rounded-0 m-3 shadow-none bg-transparent mb-0">
							<div class="card-body p-sm-5">
								<div class="p-3">
									...
									<h4 class="mt-5 font-weight-bold">Confirm OTP</h4>
									<p class="text-muted">Enter the OTP. We just sent you.</p>

                                    <form action="{{ route('varify.otp') }}" method="POST">
                                        @csrf
                                    <div class="mb-3 mt-4">
									...
									<div class="mb-4">
										...
										<input type="text" name="token" class="form-control" placeholder="Confirm password" required />
									</div>
